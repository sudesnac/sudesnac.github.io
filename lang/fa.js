...
const faPublicationsPageData = {
  ...
  type_five_title: "研究資金",
  type_five_items: [
    {
      citation: `<span class='highlight-author'>Chakraborty, S.</span> (2025–2028). <em>Gradients of brain organization in naturalistic environment across lifespan</em>.日本学術振興会 科研費 若手研究, 課題番号：	25K18575. <a href="https://kaken.nii.ac.jp/ja/grant/KAKENHI-PROJECT-25K18575/" target="_blank">Link</a>`
    },
  ]
};
...
const faResearchPageData = {
  ...
  <h3>研究の焦点</h3>
  <p>
    主にヒトの基底前部に注目し、fMRI・拡散MRI・計算モデルを用いてコリン作動性神経系が認知に与える影響を探究しています。また、加齢に伴う神経変化や、言語情報に基づいた脳バイオマーカーの開発も行っています。
  </p>

  <h3>使用技術</h3>
  <ul>
    <li>安静時および課題ベースfMRI</li>
    <li>拡散MRIおよびトラクトグラフィ</li>
    <li>脳領域分割・接続性勾配分析</li>
    <li>自然言語処理（LLM、ナラティブfMRI）</li>
    <li>多変量解析および機械学習</li>
  </ul>

  <h3>進行中の研究テーマ</h3>
  <ul>
    <li>基底前部と注意制御ネットワークの接続性</li>
    <li>ナラティブ理解と記憶の脳内表現</li>
    <li>大規模言語モデルを用いた知識リンク推論</li>
    <li>加齢に伴う記憶ネットワークと皮質形態の変化</li>
  </ul>
</div>
  `,
};
