...
const faJobsPageData = {
  ...
  education: [
    {
      degree: "博士（神経科学）",
      institution: "ウェスタンオンタリオ大学 医学部（Schulich School of Medicine and Dentistry）神経科学プログラム",
      duration: "2017年9月 – 2023年8月",
      thesisTitle: "Multimodal connectivity of the human basal forebrain",
      supervisors: ["Ali Khan", "Taylor Schmitz"],
      link: "https://uwo.scholaris.ca/items/45b61f47-6657-45e8-a074-7423dacca1e4",
    },
    {
      degree: "修士（応用認知・神経科学）",
      institution: "テキサス大学ダラス校（University of Texas at Dallas）",
      duration: "2012年8月 – 2013年12月",
    },
    {
      degree: "学士（神経科学、副専攻：化学）",
      institution: "ピッツバーグ大学（University of Pittsburgh）",
      duration: "2005年8月 – 2009年4月",
    },
  ],
  ...
  recognitions: [
    {
      ...
      description: "ウェスタンオンタリオ大学（UWO）／年間 $15,000（4年間）",
    },
    {
      title: "CAIR 若手研究者国際会議発表支援",
      description: "青山学院大学 CAIR（Center for Advanced Information technology Research）",
    },
  ],
  ...
  grants: [
    {
      title: "科研費 若手研究",
      description: "日本学術振興会（JSPS）／¥4,810,000",
      duration: "2025年 – 2028年",
  ...
  items: [
    ...
    {
      title: "助教",
      company: "青山学院大学 理工学部 情報テクノロジー学科",
      category: "Academic",
      startData: "2024年4月",
      endDate: null,
      location: "日本",
    ...
    {
      title: "客員研究員",
      company: "ウェスタンオンタリオ大学　ロバーツ研究所（Robarts Research Institute）",
      category: "Academic",
      startData: "2023年9月",
      endDate: null,
      location: "カナダ",
    ...
    },
    {
      ...
      endDate: "2023年8月",
      location: "カナダ",
      abstract: "ヒト前脳基底部のマルチモーダル結合性に関する研究",
      achievements: ["指導教員：Ali Khan、Taylor Schmitz"],
    },
    {
      title: "博士課程研究員（PhD Researcher）",
      company: "ウェスタンオンタリオ大学",
      ...
      endDate: "2019年4月",
      location: "カナダ",
      abstract: "ECT治療におけるうつ病（MDD）と海馬可塑性に関する研究",
      achievements: ["指導教員：Stefan Kohler、Ali Khan"],
    },
    ...
    // ===== Teaching =====
    {
      ...
      endDate: "2018年12月",
      location: "カナダ",
      abstract: "応用心理学（Psych 2035）",
      achievements: ["オフィスアワー、学習支援、試験対策"],
    },
    {
      title: "ティーチング・アシスタント（TA）",
      company: "ウェスタンオンタリオ大学",
      ...
      endDate: "2018年4月",
      location: "カナダ",
      abstract: "心理学入門（Psych 1000）",
      achievements: ["オフィスアワー、採点、復習セッション"],
    },

    // ===== Non-academic =====
    {
      title: "シニア・コンサルタント",
      company: "株式会社NTTデータ経営研究所",
      category: "Non-academic",
      startData: "2016年4月",
      endDate: "2017年6月",
      location: "日本",
      abstract: "神経科学知見に基づくプロダクト開発支援・コンサルティング",
      achievements: [],
    },
    {
      title: "研究員",
      company: "Araya Brain Imaging株式会社",
      category: "Non-academic",
      startData: "2015年8月",
      endDate: "2016年3月",
      location: "日本",
      abstract: "MATLAB/FSL/FreeSurfer/SPM12を用いたMRI・DTI解析",
      achievements: [],
    },
    ...
    // ===== Academic (continued) =====
    {
      ...
      endDate: "2015年7月",
      location: "米国",
      abstract: "認知症およびSuperAgingに関する構造MRI解析（FreeSurfer, SPM8）",
      achievements: [],
    },
    {
      title: "リサーチ・アシスタント（RA）",
    ...
    },
    {
      ...
      endDate: "2012年7月",
      location: "日本",
      abstract: "記憶・不安・メンタルローテーションに関するfMRI研究",
      achievements: [],
    },
    {
      title: "リサーチ・アシスタント（RA）",
    ...
    },
    {
      ...
      endDate: "2010年5月",
      location: "米国",
      abstract: "ワーキングメモリ・言語理解に関するfMRIおよび行動実験",
      achievements: [],
    },

    // ===== Other =====
    {
      title: "ボランティア翻訳（英→日・英→日）",
      company: "IEEE Japan Council Women in Engineering",
      category: "Other",
      startData: "2009年5月",
      endDate: "2011年5月",
      location: "日本",
      abstract: "技術・非技術文書の英日翻訳",
      achievements: [],
    },
    {
      title: "神経内科 インターン",
      ...
      endDate: "2008年8月",
      location: "日本",
      abstract: "アルツハイマー病・パーキンソン病患者のMRIおよび精神医学的評価の補助",
      achievements: [],
    },
    {
      title: "図書館アシスタント",
